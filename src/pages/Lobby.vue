        ...
        <v-card dark class="mx-auto" max-width="500" min-width="300" tile>
          <v-list
            ...
            <v-list-item-group>
              ...
              <v-list-item>
                <v-list-item-content>
                  <v-list-item-title>Score To Win</v-list-item-title>
                    <v-col
                      cols="2">
                      <v-btn
                        v-if="isOwner()"
                        ...
                        icon
                        rounded
                        @click.native="removeFromScoreToWin">
                        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                            <path fill="currentColor" d="M19,13H5V11H19V13Z" />
                        </svg>
                      </v-btn>
                    </v-col>
                    <v-col cols="8">{{ $store.state.currentGame.editedSettings.scoreToWin }}</v-col>
                    <v-col
                      cols="2">
                      <v-btn
                        v-if="isOwner()"
              ...
              <v-list-item>
                <v-list-item-content>
                  <v-list-item-title>Card Count</v-list-item-title>
                    <v-col
                      cols="2">
                      <v-btn
                        v-if="isOwner()"
                        ...
                        icon
                        rounded
                        @click.native="removeFromCardOptionCount">
                        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                            <path fill="currentColor" d="M19,13H5V11H19V13Z" />
                        </svg>
                      </v-btn>
                    </v-col>
                    <v-col cols="8">{{ $store.state.currentGame.editedSettings.cardOptionCount }}</v-col>
                    <v-col
                      cols="2">
                      <v-btn
                        v-if="isOwner()"
                        ...
                        icon
                        rounded
                        @click.native="addToCardOptionCount">
                        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                            <path fill="currentColor" d="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z" />
                        </svg>
                      </v-btn>
              ...
              <v-list-item>
                <v-list-item-content>
                  <v-list-item-title>Child friendly mode</v-list-item-title>
                    <v-col
                      cols="12">
                      <v-btn-toggle v-model="$store.state.currentGame.editedSettings.toggleChildMode">
                        <v-btn value="enabled">
                          Enabled
                        </v-btn>
